...
import kr.lk.lklab.aramchat.HangulProcessor;
import kr.lk.lklab.aramchat.IMEIndicator;
import kr.lk.lklab.aramchat.AramUtils;
import kr.lk.lklab.aramchat.Obfuscated.*;
...
public class Hangul_Set_2_Layout implements KeyboardLayout {
    ...
    boolean onBackspaceKeyPressed(ScreenEvent.KeyPressed.Pre event) {
    ...
    boolean onHangulCharTyped(ScreenEvent.CharacterTyped.Pre event) {
    ...
    public void typedTextField(ScreenEvent.CharacterTyped.Pre event) {
        TextComponentWrapper comp = AramUtils.getTextComponent();
        if (comp == null) return;
    ...
    public void typedTextInput(ScreenEvent.CharacterTyped.Pre event) {
    }
